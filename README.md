...
* the app - the application construct is located in the `app_main.py` file. This file uses data from the `data` folder and saved (previously trained) ML models from the `model` folder.
